...
static PyMethodDef torch_functions[] = {
  ...
  {"_add_batch_dim", (PyCFunction)(void(*)(void))THPVariable__add_batch_dim, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  ...
  {"_embedding_bag_forward_only", (PyCFunction)(void(*)(void))THPVariable__embedding_bag_forward_only, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  ...
  {"_remove_batch_dim", (PyCFunction)(void(*)(void))THPVariable__remove_batch_dim, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  ...
  {"count_nonzero", (PyCFunction)(void(*)(void))THPVariable_count_nonzero, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
...
static PyObject * THPVariable__add_batch_dim(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  auto dispatch__add_batch_dim = [](const Tensor & self, int64_t batch_dim, int64_t level) -> Tensor {
    pybind11::gil_scoped_release no_gil;
...
static PyObject * THPVariable__embedding_bag_forward_only(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_embedding_bag_forward_only(Tensor weight, Tensor indices, Tensor offsets, bool scale_grad_by_freq=False, int64_t mode=0, bool sparse=False, Tensor? per_sample_weights=None, bool include_last_offset=False)",
  }, /*traceable=*/true);
  ...
  auto dispatch__embedding_bag_forward_only = [](const Tensor & weight, const Tensor & indices, const Tensor & offsets, bool scale_grad_by_freq, int64_t mode, bool sparse, const Tensor & per_sample_weights, bool include_last_offset) -> std::tuple<Tensor,Tensor,Tensor,Tensor> {
    pybind11::gil_scoped_release no_gil;
    return at::_embedding_bag_forward_only(weight, indices, offsets, scale_grad_by_freq, mode, sparse, per_sample_weights, include_last_offset);
  };
  return wrap(dispatch__embedding_bag_forward_only(_r.tensor(0), _r.tensor(1), _r.tensor(2), _r.toBool(3), _r.toInt64(4), _r.toBool(5), _r.tensor(6), _r.toBool(7)));
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable__remove_batch_dim(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  auto dispatch__remove_batch_dim = [](const Tensor & self, int64_t level, int64_t batch_size, int64_t out_dim) -> Tensor {
    pybind11::gil_scoped_release no_gil;
...
static PyObject * THPVariable__validate_sparse_coo_tensor_args(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_validate_sparse_coo_tensor_args(Tensor indices, Tensor values, IntArrayRef size)",
  }, /*traceable=*/false);
  ...
  auto dispatch__validate_sparse_coo_tensor_args = [](const Tensor & indices, const Tensor & values, IntArrayRef size) -> void {
    pybind11::gil_scoped_release no_gil;
    at::_validate_sparse_coo_tensor_args(indices, values, size);
  };
  dispatch__validate_sparse_coo_tensor_args(_r.tensor(0), _r.tensor(1), _r.intlist(2));
  Py_RETURN_NONE;
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_count_nonzero(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  switch (_r.idx) {
    case 0: {
      ...
      auto dispatch_count_nonzero = [](const Tensor & self, IntArrayRef dim) -> Tensor {
        pybind11::gil_scoped_release no_gil;
    ...
    case 1: {
      ...
      auto dispatch_count_nonzero = [](const Tensor & self, c10::optional<int64_t> dim) -> Tensor {
        pybind11::gil_scoped_release no_gil;
        return self.count_nonzero(dim);
      };
