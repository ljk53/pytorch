...
static PyObject * THPVariable_scatter_(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  switch (_r.idx) {
    ...
    case 3: {
      ...
      auto dispatch_scatter_ = [](Tensor & self, int64_t dim, const Tensor & index, Scalar value, std::string reduce) -> Tensor {
        pybind11::gil_scoped_release no_gil;
...
PyMethodDef variable_methods[] = {
  ...
  {"count_nonzero", (PyCFunction)(void(*)(void))THPVariable_count_nonzero, METH_VARARGS | METH_KEYWORDS, NULL},
