...
struct CAFFE2_API Type {
  ...
  Tensor contiguous(const Tensor & self, MemoryFormat memory_format) const;
  ...
  Tensor & copy_(Tensor & self, const Tensor & src, bool non_blocking) const;
  Tensor _copy_from(const Tensor & self, const Tensor & dst, bool non_blocking) const;
  ...
  Tensor & resize_(Tensor & self, IntArrayRef size) const;
  ...
  Tensor & _index_put_impl_(Tensor & self, TensorList indices, const Tensor & values, bool accumulate, bool unsafe) const;
  ...
  std::tuple<Tensor,Tensor,Tensor> native_layer_norm(const Tensor & input, const Tensor & weight, const Tensor & bias, int64_t M, int64_t N, double eps) const;
  std::tuple<Tensor,Tensor,Tensor> native_layer_norm_backward(const Tensor & grad_out, const Tensor & input, const Tensor & mean, const Tensor & rstd, const Tensor & weight, int64_t M, int64_t N, std::array<bool,3> output_mask) const;
  std::tuple<Tensor,Tensor,Tensor> native_layer_norm_double_backward(const Tensor & ggI, const Tensor & ggW, const Tensor & ggb, const Tensor & gO, const Tensor & input, const Tensor & mean, const Tensor & rstd, const Tensor & weight, int64_t M, int64_t N, std::array<bool,3> output_mask) const;
  ...
  Tensor numpy_T(const Tensor & self) const;
  ...
  Tensor poisson_nll_loss(const Tensor & input, const Tensor & target, bool log_input, bool full, double eps, int64_t reduction) const;
  ...
  Tensor gelu(const Tensor & self) const;
  Tensor gelu_backward(const Tensor & grad, const Tensor & self) const;
  ...
  Tensor detach(const Tensor & self) const;
  Tensor & detach_(Tensor & self) const;
  ...
  Tensor & _sparse_dense_add_out(Tensor & out, const Tensor & self, const Tensor & other, Scalar alpha) const;
  ...
  std::tuple<Tensor,Tensor> std_mean(const Tensor & self, bool unbiased) const;
  std::tuple<Tensor,Tensor> std_mean(const Tensor & self, IntArrayRef dim, bool unbiased, bool keepdim) const;
  ...
  std::tuple<Tensor,Tensor> var_mean(const Tensor & self, bool unbiased) const;
  std::tuple<Tensor,Tensor> var_mean(const Tensor & self, IntArrayRef dim, bool unbiased, bool keepdim) const;
  ...
  Tensor nuclear_norm(const Tensor & self, IntArrayRef dim, bool keepdim) const;
  Tensor & nuclear_norm_out(Tensor & out, const Tensor & self, IntArrayRef dim, bool keepdim) const;
  Tensor clone(const Tensor & self) const;
  Tensor & resize_as_(Tensor & self, const Tensor & the_template) const;
  ...
  Tensor sparse_mask(const Tensor & self, const Tensor & mask) const;
  ...
  Tensor quantize_linear(const Tensor & self, double scale, int64_t zero_point, ScalarType dtype) const;
  Tensor quantize_linear_per_channel(const Tensor & self, const Tensor & scales, const Tensor & zero_points, IntArrayRef axis, ScalarType dtype) const;
  Tensor dequantize(const Tensor & self) const;
  Tensor _dequantize_linear(const Tensor & self, double scale, int64_t zero_point, ScalarType dtype) const;
  Scalar q_scale(const Tensor & self) const;
  Scalar q_zero_point(const Tensor & self) const;
  Tensor int_repr(const Tensor & self) const;
  Tensor _per_tensor_affine_qtensor(const Tensor & self, double scale, int64_t zero_point) const;
  ...
  std::vector<Tensor> nonzero_numpy(const Tensor & self) const;
  ...
  std::tuple<Tensor &,Tensor &> qr_out(Tensor & Q, Tensor & R, const Tensor & self, bool some) const;
  std::tuple<Tensor,Tensor> qr(const Tensor & self, bool some) const;
  std::tuple<Tensor,Tensor> _qr_helper(const Tensor & self, bool some) const;
  ...
  Tensor _addr(const Tensor & self, const Tensor & vec1, const Tensor & vec2, Scalar beta, Scalar alpha) const;
  Tensor & _addr_(Tensor & self, const Tensor & vec1, const Tensor & vec2, Scalar beta, Scalar alpha) const;
  Tensor & _addr_out(Tensor & out, const Tensor & self, const Tensor & vec1, const Tensor & vec2, Scalar beta, Scalar alpha) const;
  Tensor & _index_copy_(Tensor & self, int64_t dim, const Tensor & index, const Tensor & source) const;
  Tensor _cumsum(const Tensor & self, int64_t dim) const;
  Tensor & _cumsum_out(Tensor & out, const Tensor & self, int64_t dim) const;
  Tensor _cumprod(const Tensor & self, int64_t dim) const;
  Tensor & _cumprod_out(Tensor & out, const Tensor & self, int64_t dim) const;
  Tensor _var(const Tensor & self, bool unbiased) const;
  Tensor _std(const Tensor & self, bool unbiased) const;
  Tensor & _addmm_out(Tensor & out, const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) const;
  Tensor _addmm(const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) const;
  Tensor & _addmm_(Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) const;
  Tensor _cat(TensorList tensors, int64_t dim) const;
  Tensor & _cat_out(Tensor & out, TensorList tensors, int64_t dim) const;
  std::tuple<Tensor,Tensor> _mode(const Tensor & self, int64_t dim, bool keepdim) const;
  std::tuple<Tensor &,Tensor &> _mode_out(Tensor & values, Tensor & indices, const Tensor & self, int64_t dim, bool keepdim) const;
  std::tuple<Tensor,Tensor> _max(const Tensor & self, int64_t dim, bool keepdim) const;
  std::tuple<Tensor &,Tensor &> _max_out(Tensor & max, Tensor & max_indices, const Tensor & self, int64_t dim, bool keepdim) const;
  std::tuple<Tensor,Tensor> _min(const Tensor & self, int64_t dim, bool keepdim) const;
  std::tuple<Tensor &,Tensor &> _min_out(Tensor & min, Tensor & min_indices, const Tensor & self, int64_t dim, bool keepdim) const;
  ...
  std::tuple<Tensor &,Tensor &> max_pool2d_with_indices_out(Tensor & out, Tensor & indices, const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, bool ceil_mode) const;
  ...
  std::tuple<Tensor &,Tensor &> max_pool3d_with_indices_out(Tensor & out, Tensor & indices, const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, bool ceil_mode) const;
