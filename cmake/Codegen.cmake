...
if (TRUE)
  ...
  IF(C_AVX_FOUND AND NOT BUILD_ATEN_MOBILE)
    IF(MSVC)
  ...
  IF(C_AVX2_FOUND AND NOT BUILD_ATEN_MOBILE)
    IF(MSVC)
  ...
  IF(CXX_AVX_FOUND AND NOT BUILD_ATEN_MOBILE)
  ...
  IF(CXX_AVX2_FOUND AND NOT BUILD_ATEN_MOBILE)
