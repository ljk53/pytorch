  ...
  foreach(fil ${ARGN})
    ...
    if (${CAFFE2_LINK_LOCAL_PROTOBUF})
      ...
      add_custom_command(
        ...
        COMMAND ${CMAKE_COMMAND} -DFILENAME=${CMAKE_CURRENT_BINARY_DIR}/${fil_we}.pb.h -DNAMESPACES=caffe\;caffe2\;onnx\;torch\;jit_mobile -P ${PROJECT_SOURCE_DIR}/cmake/ProtoBufPatch.cmake
